...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/lucas-maysun-problematic-7](https://github.com/rhdh-JslYoon-org/lucas-maysun-problematic-7)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/lucas-maysun-problematic-7-gitops](https://github.com/rhdh-JslYoon-org/lucas-maysun-problematic-7-gitops)

# **Usage**

To access the lucas-maysun-problematic-7 application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed Kubernetes resources, all resources were deployed into your chosen namespace of lucas-maysun-problematic-7. You can access this namespace through the web console or via your CLI.
